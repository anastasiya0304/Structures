...
2. Далее приступим к сравнению производительности 2х структур, указанных в звдвнии. Подсчитаем время, необходимое для выполнения разных сценариев использования.
...
Будем передавать на вход текстовый файл с набором комманд, зависящем от сценария. На выходе получим файл с выведенной в него струтурой, а так же инфорцию о корректности и времени работы в командную строку.
