...
Начиная с указателя наивысшего уровня, двигаемся вперед по указателям до тех пор, пока они ссылаются на элемент, не превосходящий искомый. Затем спускаемся на один уровень ниже и снова двигаемся по тому же правилу. Если мы достигли уровня 1 и не можем идти дальше, то мы находимся как раз перед элементом, который ищем (если он там есть).можно использовать не один дополнительный список а несколько и получить за счет этого еще большее ускорение, каждый следующий список Pi будет содержать каждый k-й элемент предыдущего списка Pi-1. В том случае, если у нас будет logkN таких списков, мы получим сублинейное время поиска — O(logkN). Это очевидно, так как на каждом уровне, нам потребуется просмотреть всего k-1 элементов.
